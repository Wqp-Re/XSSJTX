...
cc._spArr=[1,2,5,10,50,100];cc._spIdx=0;cc._spNode=null;
cc._spMake=function(){
    try{
        ...
        n.setPosition(cc.v2(sz.width/2-60,sz.height/2-40));
        var lb=n.addComponent(cc.Label);
        lb.string="加速 "+(cc._spArr[cc._spIdx])+"x";
        lb.fontSize=30;lb.lineHeight=40;lb.color=cc.color(255,0,0,255); // 红色
        // 背景特效
        try{
            var bg=n.addComponent(cc.Graphics);
            bg.fillColor=cc.color(0,0,0,180);bg.strokeColor=cc.color(255,0,0,255);
            bg.lineWidth=3;bg.rect(-55,-26,110,52);bg.fill();bg.stroke();
        }catch(e){}
        n.on(cc.Node.EventType.TOUCH_END,function(){
            cc._spIdx=(cc._spIdx+1)%cc._spArr.length;
            var sp=cc._spArr[cc._spIdx];if(cc.kSpeed)cc.kSpeed(sp);
            lb.string="加速 "+sp+"x";
        });
        cc._spNode=n;
    }catch(e){}
...
setTimeout(function(){
    var t=0,ti=setInterval(function(){t++;if(t>40)clearInterval(ti);if(cc.director&&cc.director.getScene()&&cc._spMake()&&cc._spNode&&cc._spNode.isValid)clearInterval(ti);},2000);
    cc._spMake();
},1000);
