...
cc._spMake=function(){
    try{
        if(cc._spNode&&cc._spNode.isValid)return true;
        if(!cc.director)return false;
        var p=cc.find("Canvas");if(!p)p=cc.director.getScene();if(!p)return false;
        ...
        lb.fontSize=32;lb.lineHeight=42;lb.color=cc.color(255,0,0,255); // 纯红大字
...
setTimeout(function(){
    var t=0,ti=setInterval(function(){t++;if(t>40)clearInterval(ti);if(cc._spMake())clearInterval(ti);},2000);
    cc._spMake();
},1000);
