...
e.lv = Math.min(999, 5 * (1 + Math.floor(afl * 1.5)));
e.count = 1;
e.finishmonster = "";
...
if (cc.abyssMode) {
if (this.isboss) {
var coin = Math.min(500, 5 + Math.floor((cc.playerData.abyssfloor || 1) * 2));
cc.playerData.abysscoin = (cc.playerData.abysscoin || 0) + coin;
cc.playerData.additembyid(30020, coin, !0);
cc.playerData.abyssfloor = (cc.playerData.abyssfloor || 1) + 1;
cc.playerData.saveflag = !0;
cc.uiHelper.showTips("深渊通关,获得深渊币x" + coin + ",进入第" + cc.playerData.abyssfloor + "层");
}
...
n.abyssfloor && (this.abyssfloor = n.abyssfloor);
n.abysscoin && (this.abysscoin = n.abysscoin);
...
cc.battling = !0;
cc.director.loadScene("game");
} else if (17 == e) cc.uimain.createpetbook(); else if (18 == e) {
cc.abyssMode = !0;
cc.wujin = !1;
cc.hell = !1;
cc.mode1w = !1;
